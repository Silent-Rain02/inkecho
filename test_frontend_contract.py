...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_runtime_assets_are_present_and_expected_controls_are_wired(self) -> None:
        ...
        self.assertIn('if (mode !== "问答") contextParts.push', self.javascript)
        ...
        self.assertIn("assistantMessage.renderSourceReferences(fallbackSource.references, sourceQuery, fallbackSource.quality)", self.javascript)
